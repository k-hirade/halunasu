...
export function buildFeeSession(input = {}, options = {}) {
  ...
  return compactObject({
    ...
    canonicalPatientId: input.canonicalPatientId || patientId || null,
    canonicalPatientIdSource: input.canonicalPatientIdSource || (patientId ? "patient_id" : null),
    patientIdentityAliases: Array.isArray(input.patientIdentityAliases) ? input.patientIdentityAliases : [],
...
export function applyFeeSessionPatch(current = {}, patch = {}, options = {}) {
  ...
  const next = {
    ...
    ...compactObject({
      ...
      canonicalPatientId: hasOwn(patch, "canonicalPatientId") ? patch.canonicalPatientId || null : undefined,
      canonicalPatientIdSource: hasOwn(patch, "canonicalPatientIdSource") ? patch.canonicalPatientIdSource || null : undefined,
      patientIdentityAliases: hasOwn(patch, "patientIdentityAliases") ? patch.patientIdentityAliases || [] : undefined,

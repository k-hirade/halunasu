...
- run: `fee-whitebox-shadow-20260728075355423-04b28b`
- status: **complete**
...
- expected family identified (strict / shadow): 0/22 (0.0%) / 4/22 (18.2%)
- strict / shadow joint eligible spans: 0/22 (0.0%) / 0/22 (0.0%)
- strict / shadow billable inclusion: 0/22 (0.0%) / 0/22 (0.0%)
- strict / shadow standing facts: n/a / n/a
- strict / shadow safe exclusions: 0/7 (0.0%) / 1/7 (14.3%)
- retrieval outcomes: boundary_or_alias_gap=1, exact_code_top1=10, exact_code_top5=3, retrieval_miss=5, span_not_detected=1, underspecified_family=2
- current-own strict blockers: classifier_requests_llm=1, context_abstain_or_low_confidence=16, context_unresolved=14, linker_expected_code_not_in_top5=8, linker_expected_code_not_top1=3, linker_family_low_margin=8, linker_low_margin=13, linker_low_score=2, span_low_confidence=12, span_not_detected=1
- current-own shadow blockers: classifier_requests_llm=1, context_abstain_or_low_confidence=16, context_unresolved=14, linker_expected_code_not_in_top5=8, linker_expected_code_not_top1=3, linker_family_low_margin=5, linker_low_margin=6, span_not_detected=1

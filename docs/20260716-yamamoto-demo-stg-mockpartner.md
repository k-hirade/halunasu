...
| Fee施設設定の有効期間付き施設基準 | 3件（在宅系2件+明細書発行体制等加算） |
...
- `meisaisho_hakko_taisei`: 明細書発行体制等加算、デモ設定として2026-06-01から有効
...
2026-07-18に患者`1001 / 1004 / 1006 / 1007 / 1012`を再計測し、全結果で
`meisaisho_hakko_taisei`の読み込みを確認した。在宅・往診15受診への誤付与は0件で、別枠の
外来再診スモークでは`112015770`が1回・1点で導出され、承認保存後の月次にも反映された。
5患者の月次は32コード中6コードが完全一致し、候補込み13コードを検知した。結果と承認工程は
[20260718-yamamoto-demo-stg-meisaisho-5patients-20260718_171917](./20260718-yamamoto-demo-stg-meisaisho-5patients-20260718_171917/README.md)
を参照する。

...
export const cases = [
  ...
  },
  {
    ...
    soap: {
      ...
      P: [
        ...
        "尿培養結果を確認して抗菌薬を調整する。",
        "9/13入院時の検査・処置と9/14当日の管理内容は会計上分けて確認する。",
  ...
  },
  {
    ...
    distractors: [
      { type: "same_month_history", name: "前回採血", note: "同月内履歴" },
    ...
    soap: {
      ...
      A: [
        "鉄欠乏性貧血疑い。改善傾向の確認目的。",
        "同月内に類似検査歴があるため、重複算定の確認が必要。"
      ],
      P: [
        "検査結果を確認し、鉄剤再開の可否を検討する。",
        "黒色便、強い動悸、息切れがあれば早めに受診。",
        "同月内の検査履歴と今回採血の算定可否を確認する。",
        "市販鉄剤は薬剤算定対象に含めない。"
      ]
    },
    expectedExtraction: {
  ...
  },
  {
    ...
    distractors: [
      ...
      { type: "normal_result", name: "CT異常なし", note: "正常所見" },
      { type: "planned_exam", name: "循環器紹介", note: "後日予定" }
    ],
    soap: {
      S: [
